...
/**
 * Provide a text-based user interface to the searching capaibilities of the CHSearchApplication.
 * 
...
public class CHSearchFrontendFD implements CHSearchFrontendInterface {
  ...
  /**
   * This method gives user the ability to interactively add or remove individual words from their
   * query, before performing any kind of search.
   */
  ...
  /**
   * Prompts user for a list of words to search post titles for, and then displays the list of
   * results.
   */
  ...
  /**
   * Prompts user for a list of words to search post bodies for, and then displays the list of
   * results.
   */
  ...
  /**
   * Prompts user for a list of words to search post titles and bodies for, and then displays the
   * list of results.
   */
